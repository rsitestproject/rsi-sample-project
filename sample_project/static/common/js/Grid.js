...
(function(window, document, undefined) {
    ...
    // タッチイベントの有無にかかわらずfixedColsを有効にします
		this.options.fixedCols = this.options.fixedCols || 0;
	};
	...
	GridProto.generateGridBody = function() {
      ...
      // メッセージはグローバル変数を参照します
      var messages = rsi_Grid_messages || {"empty": "No results returned."}
			this.bodyStatic.innerHTML = "<DIV class='g_EmptySetMsg'>" + messages["empty"] + "</DIV>";
		}
	};
